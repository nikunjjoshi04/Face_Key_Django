...
name = 'NikunjBhimani_25'
SAVE_DESTINATION = os.path.join(TRAIN_DIR, name + '/')
print('SAVE_DESTINATION :- ', SAVE_DESTINATION)
...
while cap.isOpened():
    ...
    if cv.waitKey(1) == ord('s'):
        re = cv.imwrite(SAVE_DESTINATION + name + str(i) + '.jpg', roi)
        i = i + 1
        print(re)
